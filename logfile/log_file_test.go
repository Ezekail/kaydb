...
func testOpenLogFile(t *testing.T, ioType IOType) {
	...
	tests := []struct {
		...
		{"normal", args{"/tmp", 1, 100, List, ioType}, false},
...
func testLogFileWrite(t *testing.T, ioType IOType) {
	...
	tests := []struct {
		...
		{"nil", fields{lf}, args{nil}, false},
		{"no-value", fields{lf}, args{[]byte{}}, false},
		{"normal-1", fields{lf}, args{[]byte("lotusdb")}, false},
		{"normal-2", fields{lf}, args{[]byte("some data")}, false},
	}
